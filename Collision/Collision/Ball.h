...
#include "playerRed.h"                     // jogador do Breakout
...
{
private:
    playerRed* player;                    // ponteiro para jogador
    Sprite* sprite;                    // sprite da bola

public:
    float velX;                        // velocidade horizontal
    float velY;                        // velocidade vertical  
    float halfW;                       // metade da largura da bola
    float halfH;                       // metade da altura da bola

    Ball(playerRed* p);                   // construtor
    ~Ball();                           // destrutor
